...
if ($business_id) {
    $business_query = "SELECT name, business_profile_photo, address, opening_time, closing_time, description, category FROM businesses_tbl WHERE id = ?";
    ...
    $business_profile_photo = 'img/default-store-profile.jpg';
...
<div class="info-container">
  ...
  <?php if ($category == 1): ?>
    ...
    <form action="boat-reservation-form.php" method="POST">
...
<?php if ($category == 2): ?>
    ...
    <form action="eco-attraction-reservation-form.php" method="POST">
        <input type="hidden" name="business_id" value="<?php echo $business_id; ?>">
...
<?php endif; ?>
    ...
    <form action="reserve-table.php" method="POST">
        <input type="hidden" name="business_id" value="<?php echo $business_id; ?>">
        <label for="reservation-form" class="reservation-label">Make a reservation</label>
...
<script>
  ...
  <script>
        ...
        switch (category) {
            case 1:
                reservationFormUrl = 'user-boat-reservation-form.php?business_id=' + businessId;
                break;
            case 2:
                reservationFormUrl = 'user-ecotourism-reservation.php?business_id=' + businessId;
                break;
            case 3:
                reservationFormUrl = 'user-hotel-reservation.php?business_id=' + businessId;
                break;
            case 4:
                reservationFormUrl = 'user-table-reservation-form.php?business_id=' + businessId;
                break;
            default:
