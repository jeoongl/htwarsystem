...
if ($business_id) {
  ...
  $stmt->close();
    ...
    $query = "SELECT boat_price, environmental_fee FROM boat_fare_tbl WHERE business_id = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("i", $business_id);
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    if ($result->num_rows > 0) {
        ...
        echo "Error: Fare details not found.";
        $boat_price = $environmental_fee = 0;
    }
...
$num_people = $_POST['num_people'] ?? 0; // Default to 1 person if not set

// Calculate environmental fee and total price
$total_environmental_fee = $environmental_fee * $num_people;
$total_price = $boat_price + $total_environmental_fee;
...
<div class="reservation-container">
    ...
    <div class="store-info">
        <h1>Reserve boat to <?php echo htmlspecialchars($business_name); ?></h1>
    ...
    <form action="user-submit-boat-reservation.php" id="reservation-form" method="POST">
...
<div class="right-column">
    ...
    <div class="price-details">
            ...
            <p><strong>Boat Price:</strong> PHP <?php echo number_format($boat_price, 2); ?></p>
