...
.floating-home {
  ...
  .floating-home i {
    ...
    @media only screen and (max-width: 767px) {
      ...
      .booking-form {
      margin: 5% auto; /* Centers the form */
      padding: 20px;
      background-color: #444;
      border-radius: 10px;
...
<div class="image-container">
    ...
    <div class="description">
        ...
        <div class="buttons-wrapper">
            <div class="buttons">
                <?php if (!$is_category_3): ?>
                <a href="user-store-profile.php?business_id=<?php echo $business['id']; ?>" class="view-btn">Visit</a>
                <?php endif; ?>
                 <?php if ($is_category_3): ?>
                <a href="user-store-profile.php?business_id=<?php echo $business['id']; ?>&check_in=<?php echo urlencode($check_in); ?>&check_out=<?php echo urlencode($check_out); ?>&adults=<?php echo $adults; ?>&children=<?php echo $children; ?>&rooms=<?php echo $rooms_requested; ?>" class="view-btn">Visit</a>
                <?php endif; ?>
              </div>
        </div>
    </div>
