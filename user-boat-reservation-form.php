...
<div class="main-container">
  ...
  <form action="user-reserve-boat.php" method="POST">
  <input type="hidden" name="num_people_input" id="num-people-input" value="<?php echo htmlspecialchars($num_people); ?>">
    ...
    <div class ="form-section" id="form-section">
      ...
      <div class="form-container">
        <h2>Passenger #<?php echo $i; ?> Information</h2>
        
        <label for="name_<?php echo $i; ?>">Passenger Name:</label>
...
function addGuestForm() {
    ...
    formContainer.innerHTML = `
      <h2>Passenger #${guestCount + 1} Information</h2>
      <label for="name_${guestCount + 1}">Passenger Name:</label>
