...
if ($business_id) {
  ...
  $stmt->close();
    ...
    $query = "SELECT table_price, environmental_fee FROM table_prices_tbl WHERE business_id = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("i", $business_id);
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    if ($result->num_rows > 0) {
        ...
        $table_price = $fee['table_price'];
        $environmental_fee = $fee['environmental_fee'];
    } else {
        $table_price = $environmental_fee = 0;
    }
...
$reservation_time = $_POST['reservation_time'] ?? 'Not set';

// Calculate environmental fee and total price
$total_environmental_fee = $environmental_fee * $num_people;
$total_price = $table_price + $total_environmental_fee;
...
<div class="reservation-container">
    ...
    <div class="store-info">
        <h1>Reserve table at <?php echo htmlspecialchars($business_name); ?></h1>
        ...
        <div class="reservation-details">
            ...
            <div class="detail">
                ...
                <p><?php echo htmlspecialchars($reservation_time); ?></p>
            </div>
            <div class="detail">
    ...
    <form action="user-submit-table-reservation.php" id="reservation-form" method="POST">
        ...
        <input type="hidden" name="reservation_time" value="<?php echo htmlspecialchars($reservation_time); ?>">
...
<div class="right-column">
    ...
    <div class="price-details">
            ...
            <p><strong>Table Price:</strong> PHP <?php echo number_format($table_price, 2); ?></p>
